...
from .views import NotificationListView, delete_notification, mark_all_notifications_read, mark_notification_read, open_notification
...
urlpatterns = [
    ...
    path("<int:pk>/delete/", delete_notification, name="notification_delete"),
