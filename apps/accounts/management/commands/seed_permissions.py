    ...
    def handle(self, *args, **kwargs):
        ...
        permissions_data = [
            ...
            ('CAPA_INVESTIGATE', 'Investigate CAPA', 'Can perform CAPA investigation',
             'CAPA', 'MANAGE', 5),
            ('CAPA_RCA', 'CAPA RCA', 'Can perform CAPA root cause analysis',
             'CAPA', 'MANAGE', 6),
            ('CAPA_APPROVE_INVESTIGATION', 'Approve CAPA Investigation', 'Can approve CAPA investigation',
             'CAPA', 'APPROVE', 7),
            ...
            ('CAPA_VERIFY_ACTION', 'Verify CAPA Action', 'Can verify CAPA actions',
             'CAPA', 'APPROVE', 10),
            ('CAPA_EFFECTIVENESS', 'CAPA Effectiveness Review', 'Can perform CAPA effectiveness review',
             'CAPA', 'MANAGE', 11),
